...
namespace ps {
	namespace base {
		...
		Pixmap::Pixmap(): m_bitmap(NULL), m_width(0), m_height(0), m_depth(DEFAULT_PIXMAP_DEPTH) {
		}
		...
		{
			AnsiStr strExt = ps::dir::ExtractFileExt(AnsiStr(chrFilePath));
